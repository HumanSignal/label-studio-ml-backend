...
| [docling](/label_studio_ml/examples/docling)                                               | Layout via [IBM Docling SaaS](https://www.ibm.com/products/docling) (`DoclingServiceClient`) → canonical rectanglelabels/polygonlabels regions        | ✅              | ❌                | ❌        | DOCLING_SERVICE_URL, DOCLING_SERVE_API_KEY, LABEL_STUDIO_URL (uploads) | Set (layout categories) |
