...
categories: - Computer Vision - Object Detection - Image Annotation - Segment Anything Model - Facebook - ONNX
...
- This offers a much faster prediction than using the original Segment Anything
  Model.
- The downside is that image size must be specified _before_ using the ONNX model, and
