...
from model import SamVideoInteractive
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        choices=["DEBUG", "INFO", "WARNING", "ERROR"], default=None, help="Logging level",
    )
    parser.add_argument(
    ...
    if args.check:
        print('Check "' + SamVideoInteractive.__name__ + '" instance creation..')
        model = SamVideoInteractive(**kwargs)

    app = init_app(
        model_class=SamVideoInteractive,
