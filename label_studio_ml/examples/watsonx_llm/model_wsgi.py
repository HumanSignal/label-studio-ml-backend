...
if __name__ == "__main__":
    ...
    application = init_app(model_class=WatsonXModel, basic_auth_user=args.basic_auth_user, basic_auth_pass=args.basic_auth_pass)

    application.run(host=args.host, port=args.port, debug=args.debug)

else:
    # for uWSGI use
    application = init_app(model_class=WatsonXModel)
