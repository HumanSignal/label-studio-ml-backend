...
if __name__ == '__main__':
    ...
    logger.info(f'Successfully connected to Label Studio: {args.ls_url}')
    ...
    if isinstance(tasks[0], dict):
        ...
        tasks = [{'id': task_id, 'data': ls.tasks.get(task_id).data} for task_id in tqdm(tasks)]
